...
| `OPENDAQ_ENABLE_PCH` | Bool | `OFF` | Use precompiled headers to speed up SDK compilation. Not applied with the Intel compiler, whose precompiled headers break `std::exception_ptr` copies of exceptions.  | - |
