...
#include <ccommon.h>
    ...
    /*!
     * @brief Arguments object that defines a Core event type, and provides a set of parameters specific to a given event type.
     *
     ...
     * mute the events.
     */
    DAQ_EXTENDS_INTERFACE(daqCoreEventArgs, daqEventArgs);
     ...
     */
    daqErrCode EXPORTED daqCoreEventArgs_getParameters(daqCoreEventArgs* self, daqDict** parameters DAQ_DICT_TEMPLATE_TYPE(daqString, daqBaseObject));
