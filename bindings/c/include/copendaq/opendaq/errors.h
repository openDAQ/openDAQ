...
#define DAQ_ERRTYPE_OPENDAQ 0x01u

#define DAQ_ERR_CONNECTION_LOST             DAQ_ERROR_CODE(DAQ_ERRTYPE_OPENDAQ, 0x001u)
#define DAQ_ERR_CONNECTION_LIMIT_REACHED DAQ_ERROR_CODE(DAQ_ERRTYPE_OPENDAQ, 0x002u)
#define DAQ_ERR_SERVER_VERSION_TOO_LOW DAQ_ERROR_CODE(DAQ_ERRTYPE_OPENDAQ, 0x003u)
#define DAQ_ERR_CONTROL_CLIENT_REJECTED  DAQ_ERROR_CODE(DAQ_ERRTYPE_OPENDAQ, 0x004u)
