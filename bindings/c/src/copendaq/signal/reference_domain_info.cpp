...
void daqReferenceDomainInfo_getInterfaceId(daqIntfID* intfId)
{
...
daqErrCode daqReferenceDomainInfo_getReferenceTimeProtocol(daqReferenceDomainInfo* self, daqTimeProtocol* referenceTimeProtocol)
{
