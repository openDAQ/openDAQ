...
//
//     RTGen (CGenerator v0.7.0) on 05.03.2026 11:32:50.
// </auto-generated>
//------------------------------------------------------------------------------
...
void daqSignalPrivate_getInterfaceId(daqIntfID* intfId)
{
    *intfId = DAQ_SIGNAL_PRIVATE_INTF_ID;
}
...
daqErrCode daqSignalPrivate_sendPacketRecursiveLock(daqSignalPrivate* self, daqPacket* packet)
{
    return reinterpret_cast<daq::ISignalPrivate*>(self)->sendPacketRecursiveLock(reinterpret_cast<daq::IPacket*>(packet));
}
