...
void defineIProperty(pybind11::module_ m, PyDaqIntf<daq::IProperty, daq::IBaseObject> cls)
{
    ...
    m.def("BoolProperty", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IBoolean*, bool>& defaultValue, std::variant<daq::IBoolean*, bool>& visible){
    ...
    m.def("IntProperty", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IInteger*, int64_t>& defaultValue, std::variant<daq::IBoolean*, bool>& visible){
    ...
    m.def("FloatProperty", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IFloat*, double>& defaultValue, std::variant<daq::IBoolean*, bool>& visible){
    ...
    m.def("StringProperty", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IString*, py::str>& defaultValue, std::variant<daq::IBoolean*, bool>& visible){
    ...
    m.def("ListProperty", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IList*, py::list>& defaultValue, std::variant<daq::IBoolean*, bool>& visible){
    ...
    m.def("DictProperty", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IDict*, py::dict>& defaultValue, std::variant<daq::IBoolean*, bool>& visible){
    ...
    m.def("RatioProperty", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IRatio*, std::pair<int64_t, int64_t>>& defaultValue, std::variant<daq::IBoolean*, bool>& visible){
    ...
    m.def("ObjectProperty", [](std::variant<daq::IString*, py::str>& name, daq::IPropertyObject* defaultValue){
        return daq::ObjectProperty_Create(getVariantValue<daq::IString*>(name), defaultValue);
    }, py::arg("name"), py::arg("default_value"));

    m.def("ReferenceProperty", [](std::variant<daq::IString*, py::str>& name, daq::IEvalValue* referencedPropertyEval){
    ...
    m.def("FunctionProperty", [](std::variant<daq::IString*, py::str>& name, daq::ICallableInfo* callableInfo, std::variant<daq::IBoolean*, bool>& visible){
    ...
    m.def("SelectionProperty", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IList*, py::list>& selectionValues, std::variant<daq::IInteger*, int64_t>& defaultValue, std::variant<daq::IBoolean*, bool>& visible){
    ...
    m.def("SparseSelectionProperty", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IDict*, py::dict>& selectionValues, std::variant<daq::IInteger*, int64_t>& defaultValue, std::variant<daq::IBoolean*, bool>& visible){
    ...
    m.def("StructProperty", [](std::variant<daq::IString*, py::str>& name, daq::IStruct* defaultValue, std::variant<daq::IBoolean*, bool>& visible){
        return daq::StructProperty_Create(getVariantValue<daq::IString*>(name), defaultValue, getVariantValue<daq::IBoolean*>(visible));
    }, py::arg("name"), py::arg("default_value"), py::arg("visible"));

    m.def("EnumerationProperty", [](std::variant<daq::IString*, py::str>& name, daq::IEnumeration* defaultValue, std::variant<daq::IBoolean*, bool>& visible){
