...
void defineIPropertyBuilder(pybind11::module_ m, PyDaqIntf<daq::IPropertyBuilder, daq::IBaseObject> cls)
{
    ...
    m.def("PropertyBuilder", [](std::variant<daq::IString*, py::str>& name){
        return daq::PropertyBuilder_Create(getVariantValue<daq::IString*>(name));
    }, py::arg("name"));

    m.def("BoolPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IBoolean*, bool>& defaultValue){
    ...
    m.def("IntPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IInteger*, int64_t>& defaultValue){
        return daq::IntPropertyBuilder_Create(getVariantValue<daq::IString*>(name), getVariantValue<daq::IInteger*>(defaultValue));
    }, py::arg("name"), py::arg("default_value"));

    m.def("FloatPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IFloat*, double>& defaultValue){
        return daq::FloatPropertyBuilder_Create(getVariantValue<daq::IString*>(name), getVariantValue<daq::IFloat*>(defaultValue));
    }, py::arg("name"), py::arg("default_value"));

    m.def("StringPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IString*, py::str>& defaultValue){
        return daq::StringPropertyBuilder_Create(getVariantValue<daq::IString*>(name), getVariantValue<daq::IString*>(defaultValue));
    }, py::arg("name"), py::arg("default_value"));

    m.def("ListPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IList*, py::list>& defaultValue){
        return daq::ListPropertyBuilder_Create(getVariantValue<daq::IString*>(name), getVariantValue<daq::IList*>(defaultValue));
    }, py::arg("name"), py::arg("default_value"));

    m.def("DictPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IDict*, py::dict>& defaultValue){
        return daq::DictPropertyBuilder_Create(getVariantValue<daq::IString*>(name), getVariantValue<daq::IDict*>(defaultValue));
    }, py::arg("name"), py::arg("default_value"));

    m.def("RatioPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IRatio*, std::pair<int64_t, int64_t>>& defaultValue){
        return daq::RatioPropertyBuilder_Create(getVariantValue<daq::IString*>(name), getVariantValue<daq::IRatio*>(defaultValue));
    }, py::arg("name"), py::arg("default_value"));

    m.def("ObjectPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, daq::IPropertyObject* defaultValue){
        return daq::ObjectPropertyBuilder_Create(getVariantValue<daq::IString*>(name), defaultValue);
    }, py::arg("name"), py::arg("default_value"));

    m.def("ReferencePropertyBuilder", [](std::variant<daq::IString*, py::str>& name, daq::IEvalValue* referencedPropertyEval){
    ...
    m.def("FunctionPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, daq::ICallableInfo* callableInfo){
        return daq::FunctionPropertyBuilder_Create(getVariantValue<daq::IString*>(name), callableInfo);
    }, py::arg("name"), py::arg("callable_info"));

    m.def("SelectionPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IList*, py::list>& selectionValues, std::variant<daq::IInteger*, int64_t>& defaultValue){
    ...
    m.def("SparseSelectionPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IDict*, py::dict>& selectionValues, std::variant<daq::IInteger*, int64_t>& defaultValue){
    ...
    m.def("StructPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, daq::IStruct* defaultValue){
        return daq::StructPropertyBuilder_Create(getVariantValue<daq::IString*>(name), defaultValue);
    }, py::arg("name"), py::arg("default_value"));

    m.def("EnumerationPropertyBuilder", [](std::variant<daq::IString*, py::str>& name, daq::IEnumeration* defaultValue){
    ...
    cls.def_property("name",
        ...
        [](daq::IPropertyBuilder *object, std::variant<daq::IString*, py::str>& name)
        {
            const auto objectPtr = daq::PropertyBuilderPtr::Borrow(object);
    ...
    cls.def_property("description",
        ...
        [](daq::IPropertyBuilder *object, std::variant<daq::IString*, py::str>& description)
        {
            const auto objectPtr = daq::PropertyBuilderPtr::Borrow(object);
