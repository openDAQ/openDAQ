...
void defineIPropertyObject(pybind11::module_ m, PyDaqIntf<daq::IPropertyObject, daq::IBaseObject> cls)
{
    ...
    m.def("PropertyObjectWithClassAndManager", [](daq::ITypeManager* manager, std::variant<daq::IString*, py::str>& className){
    ...
    cls.def("set_property_value",
        [](daq::IPropertyObject *object, std::variant<daq::IString*, py::str>& propertyName, const py::object& value)
        {
            const auto objectPtr = daq::PropertyObjectPtr::Borrow(object);
    ...
    cls.def("get_property_value",
        [](daq::IPropertyObject *object, std::variant<daq::IString*, py::str>& propertyName)
        {
            const auto objectPtr = daq::PropertyObjectPtr::Borrow(object);
    ...
    */
    ...
    cls.def_property("property_order",
        nullptr,
        [](daq::IPropertyObject *object, std::variant<daq::IList*, py::list>& orderedPropertyNames)
        {
            const auto objectPtr = daq::PropertyObjectPtr::Borrow(object);
