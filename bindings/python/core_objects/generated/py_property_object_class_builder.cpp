...
void defineIPropertyObjectClassBuilder(pybind11::module_ m, PyDaqIntf<daq::IPropertyObjectClassBuilder, daq::IBaseObject> cls)
{
    ...
    m.def("PropertyObjectClassBuilder", [](std::variant<daq::IString*, py::str>& name){
        return daq::PropertyObjectClassBuilder_Create(getVariantValue<daq::IString*>(name));
    }, py::arg("name"));

    m.def("PropertyObjectClassBuilderWithManager", [](daq::ITypeManager* manager, std::variant<daq::IString*, py::str>& name){
    ...
    cls.def_property("name",
        ...
        [](daq::IPropertyObjectClassBuilder *object, std::variant<daq::IString*, py::str>& className)
        {
            const auto objectPtr = daq::PropertyObjectClassBuilderPtr::Borrow(object);
    ...
    cls.def_property("parent_name",
        ...
        [](daq::IPropertyObjectClassBuilder *object, std::variant<daq::IString*, py::str>& parentName)
        {
            const auto objectPtr = daq::PropertyObjectClassBuilderPtr::Borrow(object);
    ...
    cls.def("remove_property",
        [](daq::IPropertyObjectClassBuilder *object, std::variant<daq::IString*, py::str>& propertyName)
        {
            const auto objectPtr = daq::PropertyObjectClassBuilderPtr::Borrow(object);
    ...
    cls.def_property("property_order",
        ...
        [](daq::IPropertyObjectClassBuilder *object, std::variant<daq::IList*, py::list>& orderedPropertyNames)
        {
            const auto objectPtr = daq::PropertyObjectClassBuilderPtr::Borrow(object);
