...
void defineIEvent(pybind11::module_ m, PyDaqIntf<daq::IEvent, daq::IBaseObject> cls)
{
    ...
    cls.def("remove_handler",
        ...
        "");
    cls.def("trigger",
        [](daq::IEvent *object, const py::object& sender, daq::IEventArgs* args)
        {
            py::gil_scoped_release release;
            const auto objectPtr = daq::EventPtr<>::Borrow(object);
            auto argsPtr = daq::EventArgsPtr<>::Borrow(args);
            auto senderDaqObject = pyObjectToBaseObject(sender);
            objectPtr.trigger(senderDaqObject, argsPtr);
        },
        py::arg("sender"), py::arg("args"),
        "");
    cls.def("clear",
        [](daq::IEvent *object)
        {
