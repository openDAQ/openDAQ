...
void defineIComponent(pybind11::module_ m, PyDaqIntf<daq::IComponent, daq::IPropertyObject> cls)
{
    ...
    m.def("Component", [](daq::IContext* context, daq::IComponent* parent, std::variant<daq::IString*, py::str>& localId, std::variant<daq::IString*, py::str>& className){
    ...
    cls.def_property("name",
        ...
        [](daq::IComponent *object, std::variant<daq::IString*, py::str>& name)
        {
            const auto objectPtr = daq::ComponentPtr::Borrow(object);
    ...
    cls.def_property("description",
        ...
        [](daq::IComponent *object, std::variant<daq::IString*, py::str>& description)
        {
            const auto objectPtr = daq::ComponentPtr::Borrow(object);
    ...
    */
    ...
    cls.def("find_component",
        [](daq::IComponent *object, std::variant<daq::IString*, py::str>& id)
        {
            const auto objectPtr = daq::ComponentPtr::Borrow(object);
