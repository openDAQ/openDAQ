...
void defineIComponentStatusContainerPrivate(pybind11::module_ m, PyDaqIntf<daq::IComponentStatusContainerPrivate, daq::IBaseObject> cls)
{
    ...
    cls.def("add_status",
        [](daq::IComponentStatusContainerPrivate *object, std::variant<daq::IString*, py::str>& name, daq::IEnumeration* initialValue)
        {
    ...
    cls.def("set_status",
        [](daq::IComponentStatusContainerPrivate *object, std::variant<daq::IString*, py::str>& name, daq::IEnumeration* value)
        {
            const auto objectPtr = daq::ComponentStatusContainerPrivatePtr::Borrow(object);
