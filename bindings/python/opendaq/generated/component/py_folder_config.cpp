...
void defineIFolderConfig(pybind11::module_ m, PyDaqIntf<daq::IFolderConfig, daq::IFolder> cls)
{
    ...
    m.def("Folder", [](daq::IContext* context, daq::IComponent* parent, std::variant<daq::IString*, py::str>& localId){
        return daq::Folder_Create(context, parent, getVariantValue<daq::IString*>(localId));
    }, py::arg("context"), py::arg("parent"), py::arg("local_id"));

    m.def("FolderWithItemType", [](daq::IntfID itemType, daq::IContext* context, daq::IComponent* parent, std::variant<daq::IString*, py::str>& localId){
    ...
    m.def("IoFolder", [](daq::IContext* context, daq::IComponent* parent, std::variant<daq::IString*, py::str>& localId){
    ...
    cls.def("remove_item_with_local_id",
        [](daq::IFolderConfig *object, std::variant<daq::IString*, py::str>& localId)
        {
            const auto objectPtr = daq::FolderConfigPtr::Borrow(object);
