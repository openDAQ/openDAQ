...
void defineISearchFilter(pybind11::module_ m, PyDaqIntf<daq::ISearchFilter, daq::IBaseObject> cls)
{
    ...
    m.def("RequiredTagsSearchFilter", [](std::variant<daq::IList*, py::list>& requiredTags){
        return daq::RequiredTagsSearchFilter_Create(getVariantValue<daq::IList*>(requiredTags));
    }, py::arg("required_tags"));

    m.def("ExcludedTagsSearchFilter", [](std::variant<daq::IList*, py::list>& excludedTags){
    ...
    m.def("LocalIdSearchFilter", [](std::variant<daq::IString*, py::str>& localId){
