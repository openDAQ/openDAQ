...
void defineIDevice(pybind11::module_ m, PyDaqIntf<daq::IDevice, daq::IFolder> cls)
{
    ...
    cls.def("add_device",
        [](daq::IDevice *object, std::variant<daq::IString*, py::str>& connectionString, daq::IPropertyObject* config)
        {
            const auto objectPtr = daq::DevicePtr::Borrow(object);
    ...
    cls.def("add_function_block",
        [](daq::IDevice *object, std::variant<daq::IString*, py::str>& typeId, daq::IPropertyObject* config)
        {
            const auto objectPtr = daq::DevicePtr::Borrow(object);
    ...
    cls.def("load_configuration",
        [](daq::IDevice *object, std::variant<daq::IString*, py::str>& configuration)
        {
            const auto objectPtr = daq::DevicePtr::Borrow(object);
