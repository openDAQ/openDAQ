...
void defineIDeviceInfoConfig(pybind11::module_ m, PyDaqIntf<daq::IDeviceInfoConfig, daq::IDeviceInfo> cls)
{
    ...
    m.def("DeviceInfoConfig", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IString*, py::str>& connectionString){
    ...
    m.def("DeviceInfoConfigWithCustomSdkVersion", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IString*, py::str>& connectionString, std::variant<daq::IString*, py::str>& sdkVersion){
    ...
    cls.def_property("name",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& name)
        {
    ...
    cls.def_property("connection_string",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& connectionString)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("manufacturer",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& manufacturer)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("manufacturer_uri",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& manufacturerUri)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("model",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& model)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("product_code",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& productCode)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("device_revision",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& deviceRevision)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("hardware_revision",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& hardwareRevision)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("software_revision",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& softwareRevision)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("device_manual",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& deviceManual)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("device_class",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& deviceClass)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("serial_number",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& serialNumber)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("product_instance_uri",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& productInstanceUri)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("asset_id",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& id)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("mac_address",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& macAddress)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("platform",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& platform)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("system_type",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& type)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("system_uuid",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& uuid)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
    ...
    cls.def_property("location",
        nullptr,
        [](daq::IDeviceInfoConfig *object, std::variant<daq::IString*, py::str>& location)
        {
            const auto objectPtr = daq::DeviceInfoConfigPtr::Borrow(object);
