...
void defineIFunctionBlockType(pybind11::module_ m, PyDaqIntf<daq::IFunctionBlockType, daq::IComponentType> cls)
{
    ...
    m.def("FunctionBlockType", [](std::variant<daq::IString*, py::str>& id, std::variant<daq::IString*, py::str>& name, std::variant<daq::IString*, py::str>& description, daq::IPropertyObject* defaultConfig){
