...
void defineILoggerComponent(pybind11::module_ m, PyDaqIntf<daq::ILoggerComponent, daq::IBaseObject> cls)
{
    ...
    m.def("LoggerComponent", [](std::variant<daq::IString*, py::str>& name, std::variant<daq::IList*, py::list>& sinks, daq::ILoggerThreadPool* threadPool, daq::LogLevel level){
    ...
    cls.def_property("pattern",
        nullptr,
        [](daq::ILoggerComponent *object, std::variant<daq::IString*, py::str>& pattern)
        {
            const auto objectPtr = daq::LoggerComponentPtr::Borrow(object);
