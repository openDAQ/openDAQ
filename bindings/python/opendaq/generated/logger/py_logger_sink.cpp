...
void defineILoggerSink(pybind11::module_ m, PyDaqIntf<daq::ILoggerSink, daq::IBaseObject> cls)
{
    ...
    m.def("RotatingFileLoggerSink", [](std::variant<daq::IString*, py::str>& fileName, const size_t maxFileByteSize, const size_t maxFiles){
    ...
    m.def("BasicFileLoggerSink", [](std::variant<daq::IString*, py::str>& fileName){
    ...
    cls.def_property("pattern",
        nullptr,
        [](daq::ILoggerSink *object, std::variant<daq::IString*, py::str>& pattern)
        {
            const auto objectPtr = daq::LoggerSinkPtr::Borrow(object);
