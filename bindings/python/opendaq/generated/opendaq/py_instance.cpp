...
void defineIInstance(pybind11::module_ m, PyDaqIntf<daq::IInstance, daq::IDevice> cls)
{
    ...
    m.def("Instance", [](daq::IContext* context, std::variant<daq::IString*, py::str>& localId){
    ...
    m.def("Client", [](daq::IContext* ctx, std::variant<daq::IString*, py::str>& localId, daq::IDeviceInfo* defaultDeviceInfo, daq::IComponent* parent){
    ...
    cls.def("set_root_device",
        [](daq::IInstance *object, std::variant<daq::IString*, py::str>& connectionString, daq::IPropertyObject* config)
        {
            const auto objectPtr = daq::InstancePtr::Borrow(object);
    ...
    cls.def("add_server",
        [](daq::IInstance *object, std::variant<daq::IString*, py::str>& serverTypeId, daq::IPropertyObject* serverConfig)
        {
            const auto objectPtr = daq::InstancePtr::Borrow(object);
