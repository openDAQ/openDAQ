...
void defineIInstanceBuilder(pybind11::module_ m, PyDaqIntf<daq::IInstanceBuilder, daq::IBaseObject> cls)
{
    ...
    cls.def("set_component_log_level",
        [](daq::IInstanceBuilder *object, std::variant<daq::IString*, py::str>& component, daq::LogLevel logLevel)
        {
            const auto objectPtr = daq::InstanceBuilderPtr::Borrow(object);
    ...
    cls.def_property("module_path",
        ...
        [](daq::IInstanceBuilder *object, std::variant<daq::IString*, py::str>& path)
        {
            const auto objectPtr = daq::InstanceBuilderPtr::Borrow(object);
    ...
    cls.def_property("default_root_device_local_id",
        ...
        [](daq::IInstanceBuilder *object, std::variant<daq::IString*, py::str>& localId)
        {
            const auto objectPtr = daq::InstanceBuilderPtr::Borrow(object);
    ...
    cls.def("set_root_device",
        [](daq::IInstanceBuilder *object, std::variant<daq::IString*, py::str>& connectionString, daq::IPropertyObject* config)
        {
            const auto objectPtr = daq::InstanceBuilderPtr::Borrow(object);
    ...
    cls.def("add_discovery_server",
        [](daq::IInstanceBuilder *object, std::variant<daq::IString*, py::str>& serverName)
        {
            const auto objectPtr = daq::InstanceBuilderPtr::Borrow(object);
