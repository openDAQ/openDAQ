...
{
    return wrapInterface<daq::IGraphVisualization, daq::IBaseObject>(m, "IGraphVisualization");
}

void defineIGraphVisualization(pybind11::module_ m, PyDaqIntf<daq::IGraphVisualization, daq::IBaseObject> cls)
{
    cls.doc() = "Represents a way to get a string representation of a graph usually in some diagram description language like DOT, mermaid or D2.";
