...
void defineIServerType(pybind11::module_ m, PyDaqIntf<daq::IServerType, daq::IComponentType> cls)
{
    ...
    m.def("ServerType", [](std::variant<daq::IString*, py::str>& id, std::variant<daq::IString*, py::str>& name, std::variant<daq::IString*, py::str>& description, daq::IPropertyObject* defaultConfig){
