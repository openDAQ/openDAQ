...
void defineIDataDescriptorBuilder(pybind11::module_ m, PyDaqIntf<daq::IDataDescriptorBuilder, daq::IBaseObject> cls)
{
    ...
    cls.def_property("name",
        ...
        [](daq::IDataDescriptorBuilder *object, std::variant<daq::IString*, py::str>& name)
        {
            const auto objectPtr = daq::DataDescriptorBuilderPtr::Borrow(object);
    ...
    cls.def_property("dimensions",
        ...
        [](daq::IDataDescriptorBuilder *object, std::variant<daq::IList*, py::list>& dimensions)
        {
            const auto objectPtr = daq::DataDescriptorBuilderPtr::Borrow(object);
    ...
    cls.def_property("origin",
        ...
        [](daq::IDataDescriptorBuilder *object, std::variant<daq::IString*, py::str>& origin)
        {
            const auto objectPtr = daq::DataDescriptorBuilderPtr::Borrow(object);
    ...
    cls.def_property("struct_fields",
        ...
        [](daq::IDataDescriptorBuilder *object, std::variant<daq::IList*, py::list>& structFields)
        {
            const auto objectPtr = daq::DataDescriptorBuilderPtr::Borrow(object);
