...
void defineIDataPacket(pybind11::module_ m, PyDaqIntf<daq::IDataPacket, daq::IPacket> cls)
{
    ...
    m.def("DataPacket", [](daq::IDataDescriptor* descriptor, const size_t sampleCount, std::variant<daq::INumber*, double>& offset){
    ...
    m.def("DataPacketWithExternalMemory", [](daq::IDataPacket* domainPacket, daq::IDataDescriptor* descriptor, const size_t sampleCount, std::variant<daq::INumber*, double>& offset, void* externalMemory, daq::IDeleter* deleter, const size_t bufferSize){
    ...
    m.def("DataPacketWithDomain", [](daq::IDataPacket* domainPacket, daq::IDataDescriptor* descriptor, const size_t sampleCount, std::variant<daq::INumber*, double>& offset){
