...
void defineIDataRule(pybind11::module_ m, PyDaqIntf<daq::IDataRule, daq::IBaseObject> cls)
{
    ...
    m.def("LinearDataRule", [](std::variant<daq::INumber*, double>& delta, std::variant<daq::INumber*, double>& start){
    ...
    m.def("ExplicitDomainDataRule", [](std::variant<daq::INumber*, double>& minExpectedDelta, std::variant<daq::INumber*, double>& maxExpectedDelta){
