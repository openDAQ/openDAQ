...
void defineIDimensionRule(pybind11::module_ m, PyDaqIntf<daq::IDimensionRule, daq::IBaseObject> cls)
{
    ...
    m.def("LinearDimensionRule", [](std::variant<daq::INumber*, double>& delta, std::variant<daq::INumber*, double>& start, const size_t size){
    ...
    m.def("ListDimensionRule", [](std::variant<daq::IList*, py::list>& list){
        return daq::ListDimensionRule_Create(getVariantValue<daq::IList*>(list));
    }, py::arg("list"));

    m.def("LogarithmicDimensionRule", [](std::variant<daq::INumber*, double>& delta, std::variant<daq::INumber*, double>& start, std::variant<daq::INumber*, double>& base, const size_t size){
