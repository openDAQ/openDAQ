...
void defineIEventPacket(pybind11::module_ m, PyDaqIntf<daq::IEventPacket, daq::IPacket> cls)
{
    ...
    m.def("EventPacket", [](std::variant<daq::IString*, py::str>& id, std::variant<daq::IDict*, py::dict>& params){
    ...
    m.def("ImplicitDomainGapDetectedEventPacket", [](std::variant<daq::INumber*, double>& diff){
