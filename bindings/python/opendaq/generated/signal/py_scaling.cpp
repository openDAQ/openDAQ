...
void defineIScaling(pybind11::module_ m, PyDaqIntf<daq::IScaling, daq::IBaseObject> cls)
{
    ...
    m.def("LinearScaling", [](std::variant<daq::INumber*, double>& scale, std::variant<daq::INumber*, double>& offset, daq::SampleType inputDataType, daq::ScaledSampleType outputDataType){
