...
void defineISignalConfig(pybind11::module_ m, PyDaqIntf<daq::ISignalConfig, daq::ISignal> cls)
{
    ...
    m.def("Signal", [](daq::IContext* context, daq::IComponent* parent, std::variant<daq::IString*, py::str>& localId, std::variant<daq::IString*, py::str>& className){
    ...
    m.def("SignalWithDescriptor", [](daq::IContext* context, daq::IDataDescriptor* descriptor, daq::IComponent* parent, std::variant<daq::IString*, py::str>& localId, std::variant<daq::IString*, py::str>& className){
    ...
    cls.def_property("related_signals",
        nullptr,
        [](daq::ISignalConfig *object, std::variant<daq::IList*, py::list>& signals)
        {
            const auto objectPtr = daq::SignalConfigPtr::Borrow(object);
    ...
    cls.def("send_packets",
        [](daq::ISignalConfig *object, std::variant<daq::IList*, py::list>& packets)
        {
            const auto objectPtr = daq::SignalConfigPtr::Borrow(object);
