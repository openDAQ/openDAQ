...
- [#844](https://github.com/openDAQ/openDAQ/pull/844) Enhanced openDAQ Python dictionary iteration to support destructuring assignment syntax like `for [id_, type_] in dict.iter_pairs():` for more intuitive and efficient dictionary traversal.
