...
SizeT ListObjectPtr<T, U, V>::getCount() const
{
    ...
    SizeT size;
    DAQ_CHECK_ERROR_INFO(this->object->getCount(&size));
    return size;
}
...
void ListObjectPtr<T, U, V>::pushBack(const V& obj)
{
    ...
    DAQ_CHECK_ERROR_INFO(this->object->pushBack(obj));
}
...
void ListObjectPtr<T, U, V>::pushBack(V&& obj)
{
    ...
    DAQ_CHECK_ERROR_INFO(this->object->moveBack(obj));
    obj.detach();
}
...
void ListObjectPtr<T, U, V>::pushFront(const V& obj)
{
    ...
    DAQ_CHECK_ERROR_INFO(this->object->pushFront(obj));
}
...
void ListObjectPtr<T, U, V>::pushFront(V&& obj)
{
    ...
    DAQ_CHECK_ERROR_INFO(this->object->moveFront(obj));
    obj.detach();
}
...
void ListObjectPtr<T, U, V>::clear()
{
    ...
    DAQ_CHECK_ERROR_INFO(this->object->clear());
}
