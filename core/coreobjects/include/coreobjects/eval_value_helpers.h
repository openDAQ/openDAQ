...
public:
    ...
    virtual ErrCode Property_GetPropertyType(PropertyType* propertyType)  = 0;
    ...
    ErrCode INTERFACE_FUNC getPropertyType(PropertyType* propertyType) override
    {
        return Property_GetPropertyType(propertyType);
    }
};
