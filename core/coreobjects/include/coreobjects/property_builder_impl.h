...
public:
    ...
    ErrCode INTERFACE_FUNC setIsValueSelectionProperty(Bool isValueSelectionProperty) override;
    ErrCode INTERFACE_FUNC getIsValueSelectionProperty(Bool* isValueSelectionProperty) override;
