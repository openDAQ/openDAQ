...
{
    const std::string expectedJson = R"({"__type":"PropertyObject","className":"Test","propValues":{"Referenced":10},"properties":[{"__type":"Property","name":"LocalProp","valueType":3,"defaultValue":"-","readOnly":false,"visible":true}]})";
...
TEST_F(PropertyObjectTest, DeserializeJsonSimpleWithLocalProperty)
{
    const std::string json =
        R"({"__type":"PropertyObject","className":"Test","propValues":{"Referenced":10},"properties":[{"__type":"Property","name":"LocalProp","valueType":3,"defaultValue":"-","readOnly":false,"visible":true}]})";
