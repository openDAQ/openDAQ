...
#define OPENDAQ_PARTIAL_SUCCESS        0x00000008u
...
#define OPENDAQ_ERR_DEVICE_LOCKED                  OPENDAQ_ERROR_CODE(OPENDAQ_ERRTYPE_GENERIC, 0x0052u)
#define OPENDAQ_ERR_RESERVED_TYPE_NAME             OPENDAQ_ERROR_CODE(OPENDAQ_ERRTYPE_GENERIC, 0x0053u)

#define OPENDAQ_ERR_NOT_CLONEABLE                  OPENDAQ_ERROR_CODE(OPENDAQ_ERRTYPE_GENERIC, 0x0054u)
