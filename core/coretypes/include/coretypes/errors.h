...
#define OPENDAQ_ERR_EXISTSSAME                     OPENDAQ_ERROR_CODE(OPENDAQ_ERRTYPE_GENERIC, 0x0060u)
#define OPENDAQ_ERR_EXISTSDIFFERENT                OPENDAQ_ERROR_CODE(OPENDAQ_ERRTYPE_GENERIC, 0x0061u)
