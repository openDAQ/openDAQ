...
DEFINE_EXCEPTION(DeviceLocked, OPENDAQ_ERR_DEVICE_LOCKED, "Device locked")
...
DEFINE_EXCEPTION(DeserealizeUnknownType, OPENDAQ_ERR_DESERIALIZE_UNKNOWN_TYPE, "Unknown format of Serialize type id")
DEFINE_EXCEPTION(DeserealizeNoType, OPENDAQ_ERR_DESERIALIZE_NO_TYPE, "Serialize type id not found")
...
DEFINE_EXCEPTION(NotCloneable, OPENDAQ_ERR_NOT_CLONEABLE, "Not cloneable")
