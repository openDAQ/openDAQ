...
#define OPENDAQ_FACTORY_SELECTOR(_0, _1, _1_x, _2, _2_x, _3, _3_x, _4, _4_x, _5, _5_x, _6, _6_x, NAME, ...) NAME
...
#define OPENDAQ_INTERNAL_EXPAND(x) x
    ...
    #define OPENDAQ_INTERNAL_FACTORY_EXP_PRIVATE(SELECTOR, CM, ...) \
        OPENDAQ_INTERNAL_EXPAND(OPENDAQ_FACTORY_SELECTOR(##__VA_ARGS__, CM##_6, 6_unused, CM##_5, 5_unused, CM##_4, 4_unused, CM##_3, 3_unused, CM##_2, 2_unused, CM##_1, 1_unused, CM##_0)) \
    ...
    #define OPENDAQ_FACTORY_EXP_PRIVATE(SELECTOR, CM, ...) \
        OPENDAQ_FACTORY_SELECTOR(unused, ## __VA_ARGS__, CM##_6, unused, CM##_5, unused, CM##_4, unused, CM##_3, unused, CM##_2, unused, CM##_1, unused, CM##_0)(SELECTOR, ## __VA_ARGS__)
