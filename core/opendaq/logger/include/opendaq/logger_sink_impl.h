...
class LoggerSinkBase : public ImplementationOf<ILoggerSink>
{
public:
...
class LoggerSinkImpl : public LoggerSinkBase
{
public:
    using SinkType = TSinkType;

    LoggerSinkImpl();
    explicit LoggerSinkImpl(SinkPtr&& sink);
};
