...
TEST_F(CheckDependenciesTest, InvalidParamsFailure)
{
    ...
    ASSERT_THROW(
        checkErrorInfo(daqCoreValidateVersionMetadata(OPENDAQ_OPENDAQ_MAJOR_VERSION, OPENDAQ_OPENDAQ_MINOR_VERSION, OPENDAQ_OPENDAQ_PATCH_VERSION, dummy, dummy, dummy, nullptr)),
        ArgumentNullException
    );

    StringPtr logMessage;
    ASSERT_THROW(
        checkErrorInfo(daqCoreValidateVersionMetadata(OPENDAQ_OPENDAQ_MAJOR_VERSION, OPENDAQ_OPENDAQ_MINOR_VERSION, OPENDAQ_OPENDAQ_PATCH_VERSION, nullptr, nullptr, nullptr, &logMessage)),
        ArgumentNullException
    );
}
...
TEST_F(CheckDependenciesTest, DefaultMetadataSuccess)
{
    ...
    StringPtr logMessage;
    ErrCode errCode = daqCoreValidateVersionMetadata(major, minor, patch, branch, sha, nullptr, &logMessage);
    ASSERT_EQ(errCode, OPENDAQ_SUCCESS);
...
TEST_F(CheckDependenciesTest, MajorNumberFailure)
{
    ...
    ASSERT_THROW_MSG(checkErrorInfo(daqCoreValidateVersionMetadata(major, minor, patch, branch, sha, nullptr, &logMessage)),
