...
class MockServerModuleImpl : public daq::ImplementationOf<daq::IModule>
{
public:
    MockServerModuleImpl(daq::ContextPtr ctx, daq::IModuleManager* mng);
    ...
    daq::ErrCode INTERFACE_FUNC createDevice(daq::IDevice** device, daq::IString* connectionString, daq::IComponent* parentGlobalId, daq::IPropertyObject* config, daq::IDeviceInfo* deviceInfo) override;
...
OPENDAQ_DECLARE_CLASS_FACTORY_WITH_INTERFACE(
    INTERNAL_FACTORY, MockServerModule, daq::IModule,
