...
TEST_F(InstanceTest, GetSetRootDevice)
{
    ...
    instance.setRootDevice("daq.default://default_root_device");
}
...
TEST_F(InstanceTest, EnumerateDeviceTypes)
{
    ...
    ASSERT_TRUE(deviceTypes.hasKey("OpenDAQDefaultRootDevice"));
    auto mockDevice = deviceTypes.get("OpenDAQDefaultRootDevice");
    ASSERT_EQ(mockDevice.getId(), "OpenDAQDefaultRootDevice");
...
TEST_F(InstanceTest, AddDevice)
{
    ...
    for (const auto& deviceInfo : availableDevices)
        if (deviceInfo.getConnectionString() != "daq.default://default_root_device")
...
TEST_F(InstanceTest, AddDevicesParallelSuccess)
{
        ...
        Dict<IString, IPropertyObject>(
            {
                ...
                {"daq.default://default_root_device", nullptr}
            }
        );
    ...
    ASSERT_EQ(devices.get("daq.default://default_root_device").getInfo().getConnectionString(), "daq.default://default_root_device");

    ASSERT_EQ(instance.getDevices().getCount(), 2u);
    ASSERT_EQ(instance.getDevices()[0], devices.get("daqmock://phys_device"));
    ASSERT_EQ(instance.getDevices()[1], devices.get("daq.default://default_root_device"));
...
TEST_F(InstanceTest, AddDevicesParallelPartialSuccess)
{
    ...
    ASSERT_EQ(devices.getCount(), 2u);
    ASSERT_FALSE(devices.get("daq.default://default_root_device").assigned());
    ASSERT_TRUE(devices.get("daqmock://phys_device").assigned());

    ASSERT_EQ(errCodes.getCount(), 2u);
    ASSERT_EQ(errCodes.get("daq.default://default_root_device"), OPENDAQ_ERR_DUPLICATEITEM);
    ASSERT_EQ(errCodes.get("daqmock://phys_device"), OPENDAQ_SUCCESS);

    ASSERT_EQ(errorInfos.getCount(), 2u);
    ASSERT_TRUE(errorInfos.get("daq.default://default_root_device").assigned());
...
TEST_F(InstanceTest, AddNested)
{
    auto instance = test_helpers::setupInstance();
    auto availableDevices = instance.getAvailableDevices();
    ASSERT_EQ(availableDevices[0].getConnectionString(), "daq.default://default_root_device");
...
TEST_F(InstanceTest, SaveLoadRestoreDevice)
{
    ...
    devicesNames.emplace(instance.addDevice("daq.default://default_root_device").getName(), "daq.default://default_root_device");
    ...
    instance2.addDevice("daq.default://default_root_device");
