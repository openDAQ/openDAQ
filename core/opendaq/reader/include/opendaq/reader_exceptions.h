 ...
 */
DEFINE_READER_EXCEPTION(ReaderUnknown, OPENDAQ_ERR_READER_UNKNOWN, "Unknown reader exception")
DEFINE_READER_EXCEPTION(InvalidData, OPENDAQ_ERR_INVALID_DATA, "Samples can't be read or converted to the wanted type")
