...
daq::DataDescriptorBuilderPtr setupConfigurableDescriptor(daq::SampleType type,
                                                          ...
                                                          daq::ReferenceDomainInfoPtr referenceDomainInfo = nullptr);
...
public:
    ...
    {
        auto domainPacket =
            daq::DataPacket(setupDescriptor(daq::SampleType::UInt64, daq::LinearDataRule(1, 0), nullptr), numSamples, offset);
    ...
    auto createDomainDescriptor(std::string epoch = "",
                                ...
                                daq::DataRulePtr rule = nullptr,
                                daq::ReferenceDomainInfoPtr referenceDomainInfo = nullptr) const
    {
        if (epoch.empty())
        {
        ...
        return setupConfigurableDescriptor(daq::SampleTypeFromType<daq::ClockTick>::SampleType, rule, nullptr, referenceDomainInfo)
            .setOrigin(epoch)
...
[[nodiscard]] inline daq::DataDescriptorBuilderPtr setupConfigurableDescriptor(daq::SampleType type,
                                                                               daq::DataRulePtr rule,
                                                                               daq::ScalingPtr scaling,
                                                                               daq::ReferenceDomainInfoPtr referenceDomainInfo)
{
...
[[nodiscard]] inline daq::DataDescriptorPtr setupDescriptor(daq::SampleType type, daq::DataRulePtr rule, daq::ScalingPtr scaling)
{
