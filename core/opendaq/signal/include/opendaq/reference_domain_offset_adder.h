...
inline ReferenceDomainOffsetAdder* createReferenceDomainOffsetAdderTyped(SampleType outputType,
                                                                         ...
                                                                         SizeT sampleCount)
{
    ...
    DAQ_THROW_EXCEPTION(InvalidSampleTypeException, "Reference Domain Offset: Output type is not supported.");
}
