...
To start working with openDAQ(TM), the requisite binaries are required. They can be obtained at https://docs.opendaq.com and at https://docs-dev.opendaq.com for the latest development version. The binaries are currently available for Windows and Ubuntu (20.04 or newer).
