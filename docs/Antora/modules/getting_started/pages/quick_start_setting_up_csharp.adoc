...
To start working with openDAQ(TM), the requisite binaries are required. They can be obtained at https://docs.opendaq.com (https://docs-dev.opendaq.com for the development version), or from http://nuget.org (the recommended way).
