...
The python version the wheel is intended for can be discerned from the name of the file. Eg. opendaq-3.2.4_ad68082-cp310-cp310-win_amd64.whl is to be used with Python 3.10, as indicated by the "cp310" part of the filename.
