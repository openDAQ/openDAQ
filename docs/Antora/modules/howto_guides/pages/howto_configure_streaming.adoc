...
This information includes the streaming protocol ID (e.g. `"daq.ws"` or `"daq.ns"`) and a range of optional
...
int main()
{
    ...
    // Creates and registers a Streaming option with the ID `daq.ws` and the default port number 7414
