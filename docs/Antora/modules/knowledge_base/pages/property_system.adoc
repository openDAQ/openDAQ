...
It allows for Properties such as a xref:knowledge_base:device.adoc[Device]'s sampling
rate or an FFT xref:knowledge_base:function_blocks.adoc[Function Block]'s line count to
