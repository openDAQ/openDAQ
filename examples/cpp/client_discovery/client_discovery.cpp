...
int main(int /*argc*/, const char* /*argv*/[])
{
    ...
    for (const auto& device : devices)
    {
        ...
        for (const auto& serverCapability : info.getServerCapabilities())
        {
            std::cout << " - Supports protocol: " << serverCapability.getProtocolName() << ", by address " << serverCapability.getConnectionString() << std::endl;
        }
    }
