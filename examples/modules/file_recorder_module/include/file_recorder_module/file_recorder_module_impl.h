...
/*!
 * @brief An openDAQ module exposing two function blocks: FileRecorderFbImpl, which records the
 *     signals connected to its input ports into binary files, and FilePlayerFbImpl, which replays
 *     such a file into an output signal.
 */
class FileRecorderModule final : public Module
{
public:
    /*!
     * @brief The name of this module.
     */
    static constexpr const char* MODULE_NAME = "FileRecorderModule";

    /*!
     * @brief Constructs a new module.
     * @param context The openDAQ context object.
     */
    FileRecorderModule(ContextPtr context);
     ...
     * @throws NotFoundException This module does not support the specified function block type.
     */
