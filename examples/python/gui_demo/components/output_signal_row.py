...
class OutputSignalRow(tk.Frame):
    def __init__(self, parent, output_signal, context=None, **kwargs):
        ...
        ttk.Label(self, text=output_signal.name, anchor=tk.W).grid(row=0, column=0, sticky=tk.W)
        ttk.Label(self, text=str(last_value), anchor=tk.W).grid(row=0, column=1, sticky=tk.E)
