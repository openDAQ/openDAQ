...
/*!
 * @brief An openDAQ module which exposes a single `Recorder` object, ParquetRecorderImpl.
 */
class ParquetRecorderModule final : public Module
{
public:
    /*!
     * @brief The name of this module.
     */
    static constexpr const char* MODULE_NAME = "ParquetRecorderModule";

    /*!
     * @brief Constructs a new module.
     * @param context The openDAQ context object.
     */
    ParquetRecorderModule(ContextPtr context);
...
private:
    FunctionBlockTypePtr parquetRecorderType;
};
