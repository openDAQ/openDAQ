...
static InstancePtr CreateServerInstance()
{
    ...
    auto sigs = instance.getSignals(search::Recursive(search::Visible()));
    auto avgSigs = statistics.getSignals(search::Recursive(search::Visible()));
    auto devSigs = refDevice.getSignals(search::Recursive(search::Visible()));
