...
class ConfigClientChannelImpl : public ConfigClientBaseFunctionBlockImpl<ChannelImpl<>>
{
public:
...
inline ConfigClientChannelImpl::ConfigClientChannelImpl(const ConfigProtocolClientCommPtr& configProtocolClientComm,
                                                        ...
                                                        const ComponentPtr& parent,
                                                        const StringPtr& localId)
    : ConfigClientBaseFunctionBlockImpl<ChannelImpl<>>(configProtocolClientComm, type, ctx, parent, localId)
{
}
