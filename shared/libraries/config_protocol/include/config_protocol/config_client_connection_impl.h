...
public:
    ...
    ErrCode INTERFACE_FUNC enqueueAndStealMultiple(IList* packet) override;
...
inline ErrCode INTERFACE_FUNC ConfigClientConnectionImpl::enqueueAndSteal(IPacket* packets)
{
...
inline ErrCode INTERFACE_FUNC ConfigClientConnectionImpl::enqueueAndStealMultiple(IList* packets)
{
    OPENDAQ_PARAM_NOT_NULL(packets);
