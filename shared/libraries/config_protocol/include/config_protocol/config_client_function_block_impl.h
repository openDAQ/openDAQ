...
using ConfigClientFunctionBlockImpl = ConfigClientBaseFunctionBlockImpl<FunctionBlock>;
...
ConfigClientBaseFunctionBlockImpl<Impl>::ConfigClientBaseFunctionBlockImpl(
    ...
    const ComponentPtr& parent,
    const StringPtr& localId)
    : ConfigClientComponentBaseImpl<Impl>(configProtocolClientComm, type, ctx, parent, localId)
{
}
