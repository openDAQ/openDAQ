...
class ConfigClientInputPortImpl : public ConfigClientComponentBaseImpl<InputPortImpl>
{
public:
    using Super = ConfigClientComponentBaseImpl<InputPortImpl>;
...
inline ConfigClientInputPortImpl::ConfigClientInputPortImpl(const ConfigProtocolClientCommPtr& configProtocolClientComm,
                                                     ...
                                                     const ComponentPtr& parent,
                                                     const StringPtr& localId)
    : Super(configProtocolClientComm, ctx, parent, localId)
{
}
