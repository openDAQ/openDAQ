...
class ConfigClientIoFolderImpl : public ConfigClientBaseFolderImpl<IoFolderImpl>
{
public:
...
inline ConfigClientIoFolderImpl::ConfigClientIoFolderImpl(const ConfigProtocolClientCommPtr& configProtocolClientComm,
    ...
    : ConfigClientBaseFolderImpl<IoFolderImpl>(configProtocolClientComm, ctx, parent, localId, className, componentStandardProps)
    {
}
