...
class ConfigClientSignalImpl : public ConfigClientComponentBaseImpl<MirroredSignal>
{
public:
    template <class... Args>
...
template <class... Args>
ConfigClientSignalImpl::ConfigClientSignalImpl(const ConfigProtocolClientCommPtr& configProtocolClientComm,
                                                      const ContextPtr& ctx,
                                                      const ComponentPtr& parent,
                                                      const StringPtr& localId,
                                                      const Args&... args)
    : ConfigClientComponentBaseImpl<MirroredSignal>(configProtocolClientComm, ctx, parent, localId, args...)
{
}
