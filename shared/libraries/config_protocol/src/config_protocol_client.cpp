...
PropertyObjectPtr ConfigProtocolClientComm::getDefaultAddDeviceConfig(const std::string& globalId)
{
                                                                   ...
                                                                   const FunctionPtr& factoryCallback)
{
    ...
    if (typeId == "SyncInterface")
    {
        BaseObjectPtr obj;
        checkErrorInfo(ConfigClientSyncInterfaceImpl::Deserialize(serObj, context, factoryCallback, &obj));
        return obj;
    }
    ...
    {
        BaseObjectPtr obj;
        checkErrorInfo(DeserializeConfigClientProperty(serObj, context, factoryCallback, &obj));
        return obj;
    }
                                                                           ...
                                                                           const MirroredInputPortPrivatePtr& mirroredInputPortPrivate)
{
    ...
    {
        if (protocolVersion >= 18) // generalized client-to-device streaming enabled
        {
