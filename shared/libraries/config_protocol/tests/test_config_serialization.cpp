...
{
    const auto folder = IoFolder(nullptr, nullptr, "folder");
    folder.setName("folder_name");
    folder.setDescription("folder_desc");
    folder.getTags().add("folder_tag");

    const auto subFolder = IoFolder(nullptr, folder, "subfolder");
...
TEST_F(ConfigProtocolSerializationTest, InputPort)
{
    ...
    const auto deserializeContext = createWithImplementation<IConfigProtocolDeserializeContext, ConfigProtocolDeserializeContextImpl>(
        clientComm, NullContext(), nullptr, "ip", TypeManager());
    bool configComponentInstantiated = false;
...
TEST_F(ConfigProtocolSerializationTest, Signal)
{
    ...
    const auto deserializeContext = createWithImplementation<IConfigProtocolDeserializeContext, ConfigProtocolDeserializeContextImpl>(
        clientComm, NullContext(), nullptr, "sig", TypeManager());
    bool configComponentInstantiated = false;
...
TEST_F(ConfigProtocolSerializationTest, FunctionBlock)
{
    ...
    const auto deserializeContext = createWithImplementation<IConfigProtocolDeserializeContext, ConfigProtocolDeserializeContextImpl>(
        clientComm, NullContext(), nullptr, "fb", TypeManager());
    ...
    ASSERT_EQ(configComponentInstantiated, 11);
...
TEST_F(ConfigProtocolSerializationTest, Channel)
{
    ...
    const auto deserializeContext = createWithImplementation<IConfigProtocolDeserializeContext, ConfigProtocolDeserializeContextImpl>(
        clientComm, NullContext(), nullptr, "ch", TypeManager());
    ...
    ASSERT_EQ(configComponentInstantiated, 3);
...
TEST_F(ConfigProtocolSerializationTest, Device)
{
    ...
    const auto deserializeContext = createWithImplementation<IConfigProtocolDeserializeContext, ConfigProtocolDeserializeContextImpl>(
        clientComm, NullContext(), nullptr, "dev", TypeManager());
