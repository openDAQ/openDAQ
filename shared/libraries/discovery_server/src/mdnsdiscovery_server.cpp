...
MdnsDiscoveredDevice::MdnsDiscoveredDevice(const std::string& serviceName, 
...
mdns_record_t MdnsDiscoveredDevice::createRecord(const std::string& name, const std::string& value) const
{
