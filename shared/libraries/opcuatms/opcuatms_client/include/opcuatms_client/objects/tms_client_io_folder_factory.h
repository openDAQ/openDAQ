...
inline FolderPtr TmsClientIoFolder(const ContextPtr& context,
                                 const ComponentPtr& parent,
                                 const StringPtr& localId,
                                 const daq::opcua::tms::TmsClientContextPtr& clientContext,
                                 const opcua::OpcUaNodeId& nodeId)
{
    FolderPtr obj(createWithImplementation<IFolder, TmsClientIoFolderImpl>(context, parent, localId, clientContext, nodeId));
    return obj;
}
