...
ListPtr<ILogFileInfo> TmsClientDeviceImpl::onGetAvailableLogFiles()
{
    throw OpcUaClientCallNotAvailableException("GetAvailableLogFiles is not available for OpcUA client device");
}
