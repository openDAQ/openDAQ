...
private:
    ...
    struct CacheableBuffersGroup
    {
        size_t countOfPacketBuffers{0};
        size_t sizeOfPacketBuffers{0};
    };
    // key - autogenerated group id, value - CacheableBuffersGroup
    std::unordered_map<size_t, CacheableBuffersGroup> cacheableBuffersGroups;
    size_t currentCacheablePacketGroupId;
