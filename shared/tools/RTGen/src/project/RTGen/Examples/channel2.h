...
#include <corestructure/channel_buffer.h>
 ...
 * [addProperty(IsStored, Bool, False)]
 * [addProperty(ShouldReserveMemory, Bool, True)]
 */
DECLARE_OPENDAQ_INTERFACE(IChannel, IChannelNode)
{
    // [property(Proc)]
